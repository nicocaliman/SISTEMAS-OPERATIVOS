...
/*
ssoo@ssoohost:~/p1so/ejercicio2$ gcc -Wall -g -o primes primes.c
primes.c: In function ‘main’:
primes.c:28:6: warning: suggest parentheses around assignment used as truth value [-Wparentheses]
   28 |   if(argc = 2) {
      |      ^~~~
primes.c:29:5: warning: statement with no effect [-Wunused-value]
   29 |     atoi(argv[2]);
      |     ^~~~~~~~~~~~~

      -gcc -Wall -g -o primes primes.c -> para depurar
*/